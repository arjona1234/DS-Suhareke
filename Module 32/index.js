...
var button =dpcument.getElementById('btn_id')
...
/*var text="Digital School is in top10  best school in the world ";
var regex=/[0-9]/g;
...
/*var text="100 perfect!";
var regex=/\d/g;
document.getElementById("result10").inneHTML=text.match(regex);*/
...
/*var text="hello, hellooo, hellooo, hellooooo";
var regex=/o{3,5}/g;
